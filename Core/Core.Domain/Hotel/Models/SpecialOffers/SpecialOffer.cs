namespace Core.Domain.Hotel.Models.SpecialOffers
{
    using Common.Domain;
    ...
    public class SpecialOffer : Entity<int>, IAggregateRoot
    {
        internal SpecialOffer(string title, string content, string shortContent)
        {
