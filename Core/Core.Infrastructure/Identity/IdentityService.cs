namespace Core.Infrastructure.Identity
{
    ...
    using Common.Application.Identity.Commands;
    using Common.Application.Identity.Commands.ChangePassword;
    using Common.Application.Identity.Commands.LoginUser;
