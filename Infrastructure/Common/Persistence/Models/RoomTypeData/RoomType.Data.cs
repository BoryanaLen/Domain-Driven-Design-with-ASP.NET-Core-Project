namespace Infrastructure.Common.Persistence.Models.RoomTypeData
{
    ...
    internal class RoomTypeDataData : IInitialData
    {
        public Type EntityType => typeof(RoomTypeData);

        public IEnumerable<object> GetData()
            => new List<RoomTypeData>
            {
                new RoomTypeData("Single room", 100, 1, 0, "pictures/single-room.jpg",
